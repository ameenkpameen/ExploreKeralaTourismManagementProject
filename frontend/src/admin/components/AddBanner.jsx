...
import { addBanner, addDestination } from '../../actions/superAdminActions';
...
function AddBanner() {
    ...
    const imageUpload = (async (e)=>{
      ...
      const submitHandler = async (e) => {
          e.preventDefault();
          dispatch(addBanner(heading, description, image_url, public_id));
          setOpen(true)
        };
                  ...
                  <div className='text-center w-56'>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <div className="flex gap-4">
                                <button onClick={()=>{navigate('/superadmin/viewbanners');setOpen(false)}} className="btn bg-white text-black shadow-lg hover:bg-gray-100 p-2 rounded-lg w-full">Ok</button>
                            </div>
                          </div>
