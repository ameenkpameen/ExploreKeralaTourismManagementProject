...
function OwnerError({open, onClose,message}) {
  return (
    <div className='mt-5 flex justify-center items-center'>
        <div className="max-w-xs bg-red-500 text-sm text-white rounded-md shadow-lg items-center" role="alert">
            <div className="flex p-4">
            {message}

            <div className="ml-5" onClick={onClose}>
                <button onClick={onClose} type="button" className="inline-flex flex-shrink-0 justify-center items-center h-4 w-4 rounded-md text-white/[.5] hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-red-800 focus:ring-red-500 transition-all text-sm dark:focus:ring-offset-red-500 dark:focus:ring-red-700">
