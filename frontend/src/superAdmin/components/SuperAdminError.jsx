...
function SuperAdminError(props) {
  return (
    <div className='mt-5 flex justify-center items-center pb-3'>
        <div class="max-w-xs bg-red-500 text-sm text-white rounded-md shadow-lg items-center" role="alert">
            <div class="flex p-4">
            {props.message}
