  ...
  return (
    <div className="gradient text-white min-h-screen flex items-center">
            <div className="container mx-auto p-4 flex flex-wrap items-center">
                ...
                <Link to='/' className='border font-semibold border-white rounded p-4 hover:bg-white hover:text-black' >Go Home</Link>
                </div>
            </div>
    </div>
  )
...
export default SuperErrorComponent
