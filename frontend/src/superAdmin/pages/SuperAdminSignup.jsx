...
import { superadminRegister } from '../../actions/superAdminActions'
...
function SuperAdminSignup() {
  ...
  const {loading, error, superadminInfo} = adminsRegister
  ...
  const submitHandler = async(e)=> {
    ...
    if(password !== confirmpassword){
        ...
        dispatch(superadminRegister(firstname,lastname,phonenumber,email,password))
    }
  }
  return (
    <div>
      <div className="flex flex-col items-center min-h-screen pt-6 sm:justify-center sm:pt-0 bg-gray-50  pb-20">
                ...
                <div className="w-full px-6 py-4 mt-6 overflow-hidden bg-white shadow-xl drop-shadow-2xl sm:max-w-lg max-w-md lg:max-w-xl opacity-100 sm:rounded-lg">
                    ...
                    {message && <SuperAdminError message={message}>{message}</SuperAdminError>}
