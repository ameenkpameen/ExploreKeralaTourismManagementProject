...
import { addMessage, getMessages, getOwnerData } from '../../api/UserAPI'
...
function ChatBox({chat, currentUser, setSendMessage, recieveMessage}) {
    ...
    // Always scroll to the recent message
    // useEffect(()=>{
    ...
    <div>
      <div className="ChatBox-container">
        {chat? (
          ...
          <div className="follower">
            <div className='flex flex-row '>
                ...
                <div className="name ml-3 mt-0 flex flex-col" style={{fontSize: '1.0rem'}}>
                    <span className='font-bold text-white my-auto'>{ownerData?.firstname} {ownerData?.lastname}</span>
                </div>
            </div>
          ...
          <div className="chat-sender w-full px-8 pb-6">
            <div>
