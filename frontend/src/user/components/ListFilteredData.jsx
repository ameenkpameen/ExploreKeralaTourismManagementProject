...
import { createChatWithOwner } from '../../api/UserAPI';
  ...
  return (
    <div>
      <div className="flex justify-center">
        <div className="container min-h-screen mx-auto items-center mt-32">
          <div className="flex items-center justify-center lg:pt-20 md:pt-14 sm:pt-12">
            <h1 className="text-gray-50 text-2xl relative items-center justify-center font-bold">
              Our Packages
            </h1>
          </div>
          <div className="flex items-center justify-center lg:pt-6 md:pt-14 sm:pt-12">
            <h1 className="text-white lg:text-6xl sm:text-4xl relative items-center justify-center">
              <span className="bg-gradient-to-r from-blue-400 via-pink-400 to-red-400 text-transparent bg-clip-text font-bold">
                Enjoy Your Holiday
              </span>
            </h1>
          </div>
      ...
      {errorCatch !== "" && <TokenExpireModal message={errorCatch} />}
    </div>
  );
}
