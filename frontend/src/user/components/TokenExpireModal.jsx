...
function TokenExpireModal({message}) {
      ...
      <div  className={`fixed inset-0 flex justify-center items-center transition-colors visible bg-black/70 `}>
        ...
        `}>
          ...
          <div className="flex gap-4">
              <button onClick={()=>navigate('/login')} className="btn bg-white text-black shadow-lg hover:bg-gray-100 text-sm p-2 rounded-lg w-full">Login</button>
